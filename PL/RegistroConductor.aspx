<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroConductor.aspx.cs" Inherits="PL.RegistroConductor" %>
              ...
              <form class="rd-form rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
                <div class="row row-10 row-horizontal-10">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                    <div class="form-wrap">
                      <label class="form-label" for="contact-placa">Placa Vehiculo</label>
                      <input class="form-input" id="contact-placa" type="text" name="placa" data-constraints="@Required @PlacaNumber">
                    </div>
                  </div>
